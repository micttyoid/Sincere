...
export function firstPage(dotNetHelper, elementId) {
    ...
    setViewerMetaData(dotNetHelper, pdf);
}
...
function setViewerMetaData(dotNetHelper, pdf) {
    if (dotNetHelper == null)
        return;

    dotNetHelper.invokeMethodAsync('SetViewerMetaData', { pagesCount: pdf.pagesCount, pageNumber: pdf.pageNum });
}
